...
public partial class OutfitsWindow : Window
{
    ...
    private void Button_Write_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            TextBox_Result.Text = $"slot{ComboBox_OutfitIndex.SelectedIndex} data written successfully";
        }
        catch (Exception ex)
        {
    ...
    private void ReadOutfitsData()
    {
        try
        {
            ...
            TextBox_Result.Text = $"slot{ComboBox_OutfitIndex.SelectedIndex} data read successfully";
        }
        catch (Exception ex)
        {
            MsgBoxUtil.Exception(ex);
